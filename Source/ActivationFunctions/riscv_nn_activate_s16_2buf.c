...
void riscv_nn_activate_s16_2buf(q15_t * FUNC_RESTRICT in_vec, uint32_t size, uint16_t int_bits, riscv_nn_activation_fun  act_fun, q15_t * FUNC_RESTRICT out_vec)
{
    uint32_t  i = size;
    q15_t    *pIn = in_vec;
    q15_t    *pOut = out_vec;
