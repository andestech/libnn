                                                ...
                                                int8_t * in_tmp_buf)
{
    if ((pad_x == 0)
        ...
        && (dilation_y == 1))
    {
        return riscv_nn_conv_1x1_HWC_s8_s8_s4_asym_bias_any(in_tensor,
                    in_tensor_dim_x,
                    in_tensor_dim_y,
                    in_tensor_ch,
                    in_tensor_batch,
        ...
        && (ker_dim_y == 1))
    {
        return riscv_nn_conv_1xn_HWC_s8_s8_s4_asym_bias_any(in_tensor,
                    in_tensor_dim_x,
                    in_tensor_ch,
                    in_tensor_batch,
                    ker_weight,
    ...
    {
        return riscv_nn_conv_HWC_s8_s8_s4_asym_bias_any(in_tensor,
                    in_tensor_dim_x,
                    in_tensor_dim_y,
                    in_tensor_ch,
                    in_tensor_batch,
                                                                ...
                                                                const int32_t dilation_y)
{
    if ((pad_x == 0)
        ...
        && (dilation_y == 1))
    {
        return riscv_nn_conv_1x1_HWC_s8_s8_s4_asym_bias_any_get_buffer_size(in_tensor_ch, out_tensor_ch);
    }
    else if ((out_tensor_dim_y == 1)
        && (in_tensor_dim_y == 1)
        && (dilation_y == 1)
        && (ker_dim_y == 1))
    {
        return riscv_nn_conv_1xn_HWC_s8_s8_s4_asym_bias_any_get_buffer_size(in_tensor_dim_x,
                                                                            in_tensor_ch,
                                                                            in_tensor_batch,
                                                                            out_tensor_ch,
                                                                            ker_dim_x,
    ...
    {
        return riscv_nn_conv_HWC_s8_s8_s4_asym_bias_any_get_buffer_size(in_tensor_ch,
            ker_dim_x,
            ker_dim_y,
            out_tensor_ch);
    }
