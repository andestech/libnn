...
void conv_dw_HWC_s8_s8_s8_sym_chmult(const q7_t * in_tensor,
...
void conv_dw_HWC_s8_s8_s8_sym(const q7_t * in_tensor,
        const uint16_t in_tensor_dim,
        const uint16_t in_tensor_ch,
        const q7_t * ker_weight,
        const uint16_t out_tensor_ch,
                                   ...
                                   q15_t * in_tmp_buf)
{
    ...
    {
        conv_dw_HWC_s8_s8_s8_sym(in_tensor, in_tensor_dim, in_tensor_ch,
            ker_weight, out_tensor_ch, ker_dim, pad, stride, pre_rshift,
            out_scale, post_rshift, out_tensor, out_tensor_dim, in_tmp_buf);
    }
    else
    {
        conv_dw_HWC_s8_s8_s8_sym_chmult(in_tensor, in_tensor_dim,
