                                                    ...
                                                    q15_t * out)
{
    ...
    q15_t *pOut2 = out + out_tensor_ch;
    q15_t *pOut3 = out + out_tensor_ch * 2;
    q15_t *pOut4 = out + out_tensor_ch * 3;
    ...
    while(rowCnt > 0)
    {
        ...
        const q7_t *pB = src2;
        const q7_t *pB2 = pB + col_src1;
        const q7_t *pB3 = pB + col_src1 * 2;
        const q7_t *pB4 = pB + col_src1 * 3;
        ...
        while(colCnt > 0)
        {
            ...
            //acc += src1 * src2
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V8, NDS_VEC_V0, NDS_VEC_V4);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V9, NDS_VEC_V1, NDS_VEC_V4);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V10, NDS_VEC_V2, NDS_VEC_V4);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V11, NDS_VEC_V3, NDS_VEC_V4);

            NDS_VEC_VD4DOTS_VV(NDS_VEC_V12, NDS_VEC_V0, NDS_VEC_V5);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V13, NDS_VEC_V1, NDS_VEC_V5);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V14, NDS_VEC_V2, NDS_VEC_V5);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V15, NDS_VEC_V3, NDS_VEC_V5);

            NDS_VEC_VD4DOTS_VV(NDS_VEC_V16, NDS_VEC_V0, NDS_VEC_V6);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V17, NDS_VEC_V1, NDS_VEC_V6);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V18, NDS_VEC_V2, NDS_VEC_V6);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V19, NDS_VEC_V3, NDS_VEC_V6);

            NDS_VEC_VD4DOTS_VV(NDS_VEC_V20, NDS_VEC_V0, NDS_VEC_V7);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V21, NDS_VEC_V1, NDS_VEC_V7);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V22, NDS_VEC_V2, NDS_VEC_V7);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V23, NDS_VEC_V3, NDS_VEC_V7);
        }
        pA = pA4;
        ...
        //load bias
        NDS_VEC_VLW_V(NDS_VEC_V30, bias);
        bias += vl;

        //add bias to acc
        NDS_VEC_VADD_VV(NDS_VEC_V0, NDS_VEC_V0, NDS_VEC_V30);
        NDS_VEC_VADD_VV(NDS_VEC_V4, NDS_VEC_V4, NDS_VEC_V30);
        NDS_VEC_VADD_VV(NDS_VEC_V8, NDS_VEC_V8, NDS_VEC_V30);
        NDS_VEC_VADD_VV(NDS_VEC_V12, NDS_VEC_V12, NDS_VEC_V30);
        ...
        NDS_VEC_VSRA_VX(NDS_VEC_V0, NDS_VEC_V0, post_rshift);
        NDS_VEC_VSRA_VX(NDS_VEC_V4, NDS_VEC_V4, post_rshift);
        NDS_VEC_VSRA_VX(NDS_VEC_V8, NDS_VEC_V8, post_rshift);
        NDS_VEC_VSRA_VX(NDS_VEC_V12, NDS_VEC_V12, post_rshift);
        ...
        //store the results
        NDS_VEC_VSH_V(NDS_VEC_V0, out);
        NDS_VEC_VSH_V(NDS_VEC_V4, pOut2);
        NDS_VEC_VSH_V(NDS_VEC_V8, pOut3);
        NDS_VEC_VSH_V(NDS_VEC_V12, pOut4);
        out += vl;
        pOut2 += vl;
        pOut3 += vl;
        pOut4 += vl;
    ...
    if(out_tensor_ch & 0x2)
    {
        ...
        while(colCnt > 0)
        {
            ...
            //acc += src1 * src2
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V0, NDS_VEC_V16, NDS_VEC_V20);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V2, NDS_VEC_V18, NDS_VEC_V20);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V4, NDS_VEC_V16, NDS_VEC_V22);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V6, NDS_VEC_V18, NDS_VEC_V22);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V8, NDS_VEC_V16, NDS_VEC_V24);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V10, NDS_VEC_V18, NDS_VEC_V24);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V12, NDS_VEC_V16, NDS_VEC_V26);
            NDS_VEC_VD4DOTS_VV(NDS_VEC_V14, NDS_VEC_V18, NDS_VEC_V26);
        }
        ...
        //add bias to acc
        NDS_VEC_VADD_VV(NDS_VEC_V16, NDS_VEC_V16, NDS_VEC_V30);
        NDS_VEC_VADD_VV(NDS_VEC_V18, NDS_VEC_V18, NDS_VEC_V30);
        NDS_VEC_VADD_VV(NDS_VEC_V20, NDS_VEC_V20, NDS_VEC_V30);
        NDS_VEC_VADD_VV(NDS_VEC_V22, NDS_VEC_V22, NDS_VEC_V30);
        ...
        //saturate into 8-bits
        NDS_VEC_VSRA_VX(NDS_VEC_V16, NDS_VEC_V16, post_rshift);
        NDS_VEC_VSRA_VX(NDS_VEC_V18, NDS_VEC_V18, post_rshift);
        NDS_VEC_VSRA_VX(NDS_VEC_V20, NDS_VEC_V20, post_rshift);
        NDS_VEC_VSRA_VX(NDS_VEC_V22, NDS_VEC_V22, post_rshift);
        ...
        //store the results
        NDS_VEC_VSH_V(NDS_VEC_V16, out);
        NDS_VEC_VSH_V(NDS_VEC_V18, pOut2);
        NDS_VEC_VSH_V(NDS_VEC_V20, pOut3);
        NDS_VEC_VSH_V(NDS_VEC_V22, pOut4);
        out += vl;
        pOut2 += vl;
        pOut3 += vl;
        pOut4 += vl;
    ...
    while(rowCnt > 0)
    {
        ...
        while(colCnt > 0)
        {
            ...
            //acc += src1 * src2
            NDS_VEC_VQMACC_VV(NDS_VEC_V8, NDS_VEC_V0, NDS_VEC_V4);
            NDS_VEC_VQMACC_VV(NDS_VEC_V9, NDS_VEC_V1, NDS_VEC_V4);
            NDS_VEC_VQMACC_VV(NDS_VEC_V10, NDS_VEC_V2, NDS_VEC_V4);
            NDS_VEC_VQMACC_VV(NDS_VEC_V11, NDS_VEC_V3, NDS_VEC_V4);

            NDS_VEC_VQMACC_VV(NDS_VEC_V12, NDS_VEC_V0, NDS_VEC_V5);
            NDS_VEC_VQMACC_VV(NDS_VEC_V13, NDS_VEC_V1, NDS_VEC_V5);
            NDS_VEC_VQMACC_VV(NDS_VEC_V14, NDS_VEC_V2, NDS_VEC_V5);
            NDS_VEC_VQMACC_VV(NDS_VEC_V15, NDS_VEC_V3, NDS_VEC_V5);

            NDS_VEC_VQMACC_VV(NDS_VEC_V16, NDS_VEC_V0, NDS_VEC_V6);
            NDS_VEC_VQMACC_VV(NDS_VEC_V17, NDS_VEC_V1, NDS_VEC_V6);
            NDS_VEC_VQMACC_VV(NDS_VEC_V18, NDS_VEC_V2, NDS_VEC_V6);
            NDS_VEC_VQMACC_VV(NDS_VEC_V19, NDS_VEC_V3, NDS_VEC_V6);

            NDS_VEC_VQMACC_VV(NDS_VEC_V20, NDS_VEC_V0, NDS_VEC_V7);
            NDS_VEC_VQMACC_VV(NDS_VEC_V21, NDS_VEC_V1, NDS_VEC_V7);
            NDS_VEC_VQMACC_VV(NDS_VEC_V22, NDS_VEC_V2, NDS_VEC_V7);
            NDS_VEC_VQMACC_VV(NDS_VEC_V23, NDS_VEC_V3, NDS_VEC_V7);
        ...
        //load bias
        NDS_VEC_VLW_V(NDS_VEC_V30, bias);
        // NDS_VEC_VADD_VX(NDS_VEC_V30, NDS_VEC_V30, NN_ROUND(out_rshift));
        bias += vl;
    ...
    if(out_tensor_ch & 0x2)
    {
        ...
        while(colCnt > 0)
        {
            ...
            //acc += src1 * src2
            NDS_VEC_VQMACC_VV(NDS_VEC_V8, NDS_VEC_V0, NDS_VEC_V4);
            NDS_VEC_VQMACC_VV(NDS_VEC_V10, NDS_VEC_V1, NDS_VEC_V4);

            NDS_VEC_VQMACC_VV(NDS_VEC_V12, NDS_VEC_V0, NDS_VEC_V5);
            NDS_VEC_VQMACC_VV(NDS_VEC_V14, NDS_VEC_V1, NDS_VEC_V5);

            NDS_VEC_VQMACC_VV(NDS_VEC_V16, NDS_VEC_V0, NDS_VEC_V6);
            NDS_VEC_VQMACC_VV(NDS_VEC_V18, NDS_VEC_V1, NDS_VEC_V6);

            NDS_VEC_VQMACC_VV(NDS_VEC_V20, NDS_VEC_V0, NDS_VEC_V7);
            NDS_VEC_VQMACC_VV(NDS_VEC_V22, NDS_VEC_V1, NDS_VEC_V7);
