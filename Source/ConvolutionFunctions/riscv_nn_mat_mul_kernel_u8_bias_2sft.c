                                                ...
                                                u8_t * out)
{
    ...
    u8_t *pOut2 = out + out_tensor_ch;
    u8_t *pOut3 = out + out_tensor_ch * 2;
    u8_t *pOut4 = out + out_tensor_ch * 3;
    ...
    while(rowCnt > 0)
    {
        ...
        NDS_VEC_VMAX_VX(NDS_VEC_V0, NDS_VEC_V0, 0);
        NDS_VEC_VMAX_VX(NDS_VEC_V4, NDS_VEC_V4, 0);
        NDS_VEC_VMAX_VX(NDS_VEC_V8, NDS_VEC_V8, 0);
        NDS_VEC_VMAX_VX(NDS_VEC_V12, NDS_VEC_V12, 0);
        ...
        NDS_VEC_VNCLIPU_WI(NDS_VEC_V0, NDS_VEC_V0, 0);
        NDS_VEC_VNCLIPU_WI(NDS_VEC_V4, NDS_VEC_V4, 0);
        NDS_VEC_VNCLIPU_WI(NDS_VEC_V8, NDS_VEC_V8, 0);
        NDS_VEC_VNCLIPU_WI(NDS_VEC_V12, NDS_VEC_V12, 0);
    ...
    if(out_tensor_ch & 0x2)
    {
        ...
        //saturate into 8-bits
        NDS_VEC_VMAX_VX(NDS_VEC_V16, NDS_VEC_V16, 0);
        NDS_VEC_VMAX_VX(NDS_VEC_V18, NDS_VEC_V18, 0);
        NDS_VEC_VMAX_VX(NDS_VEC_V20, NDS_VEC_V20, 0);
        NDS_VEC_VMAX_VX(NDS_VEC_V22, NDS_VEC_V22, 0);
        ...
        NDS_VEC_VNCLIPU_WI(NDS_VEC_V16, NDS_VEC_V16, 0);
        NDS_VEC_VNCLIPU_WI(NDS_VEC_V18, NDS_VEC_V18, 0);
        NDS_VEC_VNCLIPU_WI(NDS_VEC_V20, NDS_VEC_V20, 0);
        NDS_VEC_VNCLIPU_WI(NDS_VEC_V22, NDS_VEC_V22, 0);
    ...
    while(rowCnt > 0)
    {
        ...
        //saturate into 8-bits
        NDS_VEC_VMAX_VX(NDS_VEC_V0, NDS_VEC_V0, 0);     //for negatives (rvv doesn't support saturate signed into unsigned)
        NDS_VEC_VMAX_VX(NDS_VEC_V4, NDS_VEC_V4, 0);     //for negatives (rvv doesn't support saturate signed into unsigned)
        NDS_VEC_VMAX_VX(NDS_VEC_V8, NDS_VEC_V8, 0);     //for negatives (rvv doesn't support saturate signed into unsigned)
        NDS_VEC_VMAX_VX(NDS_VEC_V12, NDS_VEC_V12, 0);   //for negatives (rvv doesn't support saturate signed into unsigned)
        NDS_VEC_VSETVLI_E16(vl, 4);     //4: 4 acc
        NDS_VEC_VNSRA_WX(NDS_VEC_V0, NDS_VEC_V0, post_rshift);
        NDS_VEC_VNSRA_WX(NDS_VEC_V4, NDS_VEC_V4, post_rshift);
        NDS_VEC_VNSRA_WX(NDS_VEC_V8, NDS_VEC_V8, post_rshift);
