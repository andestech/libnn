...
void conv_dw_HWC_s8_s8_s8_sym_bias_any_chmult(const q7_t * in_tensor,
...
void conv_dw_HWC_s8_s8_s8_sym_bias_any(const q7_t * in_tensor,
        const uint16_t in_tensor_dim_x,
        const uint16_t in_tensor_dim_y,
        const uint16_t in_tensor_ch,
        const q7_t * ker_weight,
        ...
        q15_t * in_tmp_buf)
{
    ...
    {
        conv_dw_HWC_s8_s8_s8_sym_bias_any(in_tensor, in_tensor_dim_x,
            in_tensor_dim_y, in_tensor_ch, ker_weight, out_tensor_ch, ker_dim_x,
            ker_dim_y, pad_x, pad_y, stride_x, stride_y, bias, pre_rshift,
            out_scale, post_rshift, out_tensor, out_tensor_dim_x,
            out_tensor_dim_y, in_tmp_buf);
    }
    else
    {
        conv_dw_HWC_s8_s8_s8_sym_bias_any_chmult(in_tensor, in_tensor_dim_x,
            in_tensor_dim_y, in_tensor_ch, ker_weight, out_tensor_ch, ker_dim_x,
            ker_dim_y, pad_x, pad_y, stride_x, stride_y, bias, pre_rshift,
            out_scale, post_rshift, out_tensor, out_tensor_dim_x,
            out_tensor_dim_y, in_tmp_buf);
